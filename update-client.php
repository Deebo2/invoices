<?php
    ...
    if (isset($_GET['id'])) {
        ...
        {
            $sql = "SELECT * FROM clients WHERE id != :id AND `$key`=:val";
        ...
        if ($result->rowCount() == 1) {
            $clientInfo = $result->fetch(PDO::FETCH_ASSOC);
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <?php endif; ?> 
                                    <form role="form" method="POST" action="update-client.php?id=<?= $_GET['id']; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="mobile" value="<?php
                                                 if (isset($_POST['mobile'])) {
                                                     ...
                                                     if (isset($clientInfo['mobile'])) {
                                                         echo $clientInfo['mobile'];
                                                     }
                                                 }
