<?php
    ...
    if(isset($_GET['id'])){
        ...
        if ($result->rowCount() == 1) {
            $serviceInfo = $result->fetch(PDO::FETCH_ASSOC);
        }
    if (isset($_POST['submit'])) {
        ...
        if (!isset($errors)) {
            ...
            $sql = "UPDATE items SET name=:name, description=:description, type='service', price=:price, updated=NOW() WHERE id=:id";
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <?php if (!empty($errors['token'])):  ?>
                                    ...
                                    <?php endif; ?> 
                                    <form role="form"  method="POST" action="update-service.php?id=<?= $_GET['id'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="price" value="<?php
                                                if (isset($_POST['price'])) {
                                                    ...
                                                    if (isset($serviceInfo['price'])) {
                                                        echo $serviceInfo['price'];
                                                    }
                                                }
